...
if task == "Train":
    ...
    label_id = "labelsTs"
# Directories
labelsTr_dir = f"/mnt/nfs/slow_ai_team/organ_segmentation/nnunet_liverv0.0/nnUNet_raw_database/nnUNet_raw/nnUNet_raw_data/Dataset019_AutoPET2024/{label_id}"
labelsTr_Totalsegmentator_v1_dir = f"/mnt/nfs/slow_ai_team/organ_segmentation/nnunet_liverv0.0/nnUNet_raw_database/nnUNet_raw/nnUNet_raw_data/Dataset019_AutoPET2024/{label_id}_Totalsegmentator_v1"
labelsTr_combined_dir = f"/mnt/nfs/slow_ai_team/organ_segmentation/nnunet_liverv0.0/nnUNet_raw_database/nnUNet_raw/nnUNet_raw_data/Dataset019_AutoPET2024/{label_id}_combined"
...
df.to_csv(f"healthy_tumor_patients_report_{task}.csv")
...
images_tr_path = Path(dest_dir, f"{image_id}").resolve()
institution = "BAMF"
modalities = ["CT", "PET"]
labels = [
    "background",
